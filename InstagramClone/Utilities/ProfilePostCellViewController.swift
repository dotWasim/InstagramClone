//
//  ProfilePostCellViewController.swift
//  InstagramClone
//
//  Created by Wasim Alatrash on 2/3/20.
...
class ProfilePostCellViewController: UICollectionViewController, HomePostCellDelegate {
